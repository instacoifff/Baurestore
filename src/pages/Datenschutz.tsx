        ...
        <div className="section-container max-w-5xl">
          ...
          <div className="prose prose-lg max-w-none">
            <div className="space-y-8 text-muted-foreground">
              ...
              <section>
                <h2 className="text-foreground font-semibold text-2xl mb-4">1) Einleitung und Kontaktdaten des Verantwortlichen</h2>
                <p className="mb-4">
                  1.1 Wir freuen uns, dass Sie unsere Website besuchen, und bedanken uns für Ihr Interesse. Im Folgenden informieren wir Sie über den Umgang mit Ihren personenbezogenen Daten bei der Nutzung unserer Website. Personenbezogene Daten sind hierbei alle Daten, mit denen Sie persönlich identifiziert werden können.
                </p>
                <p>
                  1.2 Verantwortlicher für die Datenverarbeitung auf dieser Website im Sinne der Datenschutz-Grundverordnung (DSGVO) ist Oussama Hamami, BauRestore, Friedrich Ebert Strasse 18a, 68526 Ladenburg, Deutschland, Tel.: +4915205280748, E-Mail: info@baurestore.de. Der für die Verarbeitung von personenbezogenen Daten Verantwortliche ist diejenige natürliche oder juristische Person, die allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten entscheidet.
                </p>
              </section>

              <section>
                <h2 className="text-foreground font-semibold text-2xl mb-4">2) Datenerfassung beim Besuch unserer Website</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-foreground font-semibold text-2xl mb-4">3) Kontaktaufnahme</h2>
                <div className="mb-4">
                  <h3 className="text-foreground font-semibold text-xl mb-3">3.1 WhatsApp-Business</h3>
                  <p className="mb-2">
                ...
                <div className="mb-4">
                  <h3 className="text-foreground font-semibold text-xl mb-3">3.2 Kontaktformular/E-Mail</h3>
                  <p>
                ...
                <div>
                  ...
                  <p className="mb-2">
                    Sofern Nutzer im Rahmen der Kontaktaufnahme freiwillig Bilddateien (insbesondere Fotografien eines beschädigten Objekts) hochladen, werden diese ausschließlich zum Zweck der Analyse und Bewertung des gemeldeten Schadens verarbeitet.
                  </p>
                  <p className="mb-2">
                    Die Bereitstellung der Bilddateien erfolgt freiwillig und ist nicht zwingend erforderlich. Die Verarbeitung der hochgeladenen Bilder dient ausschließlich der Bearbeitung des jeweiligen Anliegens. Eine Verarbeitung zu anderen Zwecken oder eine Weitergabe an Dritte findet nicht statt.
                  </p>
                  <p className="mb-2">
                    Die Verarbeitung erfolgt gemäß Art. 6 Abs. 1 lit. b DSGVO, sofern sie zur Durchführung vorvertraglicher Maßnahmen oder zur Erfüllung eines Vertrages erforderlich ist, andernfalls auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO aufgrund unseres berechtigten Interesses an einer effizienten und sachgerechten Schadensbewertung.
                  </p>
                  <p>
                    Die hochgeladenen Bilddateien werden nur so lange gespeichert, wie dies zur Erreichung des vorgenannten Zwecks erforderlich ist, und nach Abschluss der Analyse unverzüglich gelöscht, sofern keine gesetzlichen Aufbewahrungspflichten entgegenstehen.
                  </p>
                </div>
              </section>

              <section>
                <h2 className="text-foreground font-semibold text-2xl mb-4">4) Webanalysedienste</h2>
                <div className="mb-4">
                  <h3 className="text-foreground font-semibold text-xl mb-3">Google Analytics 4</h3>
                  <p className="mb-2">
                  ...
                  <p className="mb-2">
                    Weitere rechtliche Hinweise zu Google Analytics 4 finden Sie unter <a href="https://business.safety.google/intl/de/privacy/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://business.safety.google/intl/de/privacy/</a>, <a href="https://policies.google.com/privacy?hl=de&gl=de" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://policies.google.com/privacy?hl=de&gl=de</a> und unter <a href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://policies.google.com/technologies/partner-sites</a>
                  </p>
                  <div className="mb-2">
                    <h4 className="text-foreground font-semibold mb-2">Demografische Merkmale</h4>
                    <p>
              ...
              <section>
                <h2 className="text-foreground font-semibold text-2xl mb-4">5) Seitenfunktionalitäten</h2>
                <div className="mb-4">
                  <h3 className="text-foreground font-semibold text-xl mb-3">5.1 Google Maps</h3>
                  <p className="mb-2">
                ...
                <div>
                  ...
                  <p className="mt-2">
                    Weitere Hinweise zu den Datenschutzbestimmungen von Google finden sich hier: <a href="https://business.safety.google/intl/de/privacy/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://business.safety.google/intl/de/privacy/</a>
                  </p>
                </div>
              </section>

              <section>
                <h2 className="text-foreground font-semibold text-2xl mb-4">6) Rechte des Betroffenen</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-foreground font-semibold text-2xl mb-4">7) Dauer der Speicherung personenbezogener Daten</h2>
                <p className="mb-2">
